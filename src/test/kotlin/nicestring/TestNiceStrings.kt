...
class TestNiceStrings {
    ...
    @Test
    fun testExample7() = testNiceString("b", false)

    @Test
    fun testExample8() = testNiceString("bb", true)

    @Test
    fun testExample9() = testNiceString("bbb", true)

    @Test
    fun testExample10() = testNiceString("aio", true)

    @Test
    fun testExample11() = testNiceString("baio", false)

    @Test
    fun testExample12() = testNiceString("baaio", true)
